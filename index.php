...
<body>
	...
	<div class="sell-box">
		...
		<p class="home-desc">SELLing as a 3 Step Process:</p>
			<ol>
				<li>Fill and submit a form with the complete details and your contact info.</li>
				<li>Wait for the verification process.</li>
	...
	<div class="rent-box">
		<h1>RENT</h1>
		<p class="home-desc">Now you can also RENT your books, thanks to this new feature!! </p>
