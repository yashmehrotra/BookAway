...
$SELECT_BEGIN = '<select name="clg" class="sell-input" id="search-filters-college-search"  autofocus="autofocus" autocorrect="on" autocomplete="off" placeholder="Select College"><option value="">Select College</option>';
$SELECT_END   = '</select>';
