...
Name:*	<div id="error"></div>      <input type="text" name="name" id="name" class="sell-input" autocomplete="on" required>
<br>
...
<select name="rentpricetime" id="rent-price" class="sell-input">
	...
	<option value="50d">per 50 Days</option>
	<option value="100d">per 100 Days</option>
</select>
<br>
Maximum Renting Period: <input type="number" min="1" name="rentperiodnumber" class="sell-input">
